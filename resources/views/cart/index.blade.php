    ...
    <div class="row">
        <div class="col-md-6 col-lg-8 mb-4">
            ...
            <form action="{{ route('transactions.store') }}" method="post">
                ...
                <div class="row mt-2">
                    <div class="col">incoming Cash:</div>
                    <div class="col text-right">
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <div class="order-product product-search" style="height:600px; overflow-y:scroll;">
                @foreach($products as $product)
                    <button type="button"
                        class="item"
                        style="cursor: pointer; border: none; height: 55px; background: #d7dae3; width:100%"
                        value="{{ $product->id }}"
                    ...
                    >
                        ...
                        @endif
                        <h6 style="margin: 0;">{{ $product->name }} &nbsp;&nbsp; (${{ $product->price }})</h6>
